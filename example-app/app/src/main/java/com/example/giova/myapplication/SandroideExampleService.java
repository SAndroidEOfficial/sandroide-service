...
public class SandroideExampleService extends IntentService implements BeaconConsumer {
    protected static final String TAG = "SandroideExampleService";
    ...
    public SandroideExampleService()
    {
        super("SandroideExampleService");
    }
